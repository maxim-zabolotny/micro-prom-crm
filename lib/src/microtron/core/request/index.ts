...
export class Request {
    ...
    protected parse<TEntity extends Record<string, unknown>>(data: IResponseRaw<Record<string, unknown>>): IResponse<TEntity> {
    ...
    protected async makeRequest<TEntity extends Record<string, unknown>>(resource: string, data: Record<string, unknown> = {}): Promise<AxiosResponse<IResponseRaw<TEntity>>> {
